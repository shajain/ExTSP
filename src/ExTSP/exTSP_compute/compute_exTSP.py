from ExTSP.config import PTSE_file_gtex, MutPred2_processed_file, exTSP_file, MANE_transcripts_file
import pandas as pd

from pathlib import Path

def generate_exTSP_scores(df_mp2, df_ptse, df_mane=None):
    ...
    if df_mane is not None:
        ...
        df_exTSP = df_exTSP[["Gene", "Transcript", "Transcript_id", "Variant", "Tissue",  
                            "MutPred2", "IsoPath", "ptse", "exTSP", "meanTPM"]]
    return df_exTSP
